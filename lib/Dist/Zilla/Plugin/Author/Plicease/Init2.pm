...
sub gather_file_travis_yml
{
  ...
  my $file = Dist::Zilla::File::InMemory->new({
    ...
    content => join("\n", q{language: perl},
                          ...
                          q{  - cpanm -n Test::CPAN::Changes Test::EOL Test::Fixme Test::NoTabs Test::Pod::Spelling::CommonMistakes Test::Spelling Test::Strict Test::Version || true},
                          q{#  - cpanm -n Foo::Bar},
                          q{},
                          q{perl:},
                          (map { "  - \"5.$_\""} qw( 8 10 12 14 16 18 )),
                          q{},
                          q{#env:},
                          q{#  - FOO=bar},
                          q{},
